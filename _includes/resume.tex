...
\resumeSubHeadingListStart
\resumeSubItem{ECON 380: Research Assistant}{(Fall 2020) Production function estimation with Prof.\ Daniel Ackerberg. Supported experiments on consistency of estimator given assumptions about capital accumulation process. Wrote Monte Carlo simulations in Julia and MATLAB to demonstrate theoretical results.}
\vspace{2pt}
